...
public class Stepdefs {
    ...
    public void tooShortNameAndValidPasswordAndConfirmationAreGiven(String username, String password) {
        createUserWith(username, password, password);
    }
    ...
    @When("a valid username {string} and password {string} but non-matching password confirmation are entered")
    public void validUsernameAndPasswordWrongConfirmationAreGiven(String username, String password) {
        createUserWith(username, password, "salainenwrong");
    }

    @Given("user with username {string} with password {string} is successfully created")
    public void userIsCreatedWithValidUsernameAndPassword(String username, String password) {
        newUserIsSelected();
        createUserWith(username, password, password);
    }

    @Given("user with username {string} and password {string} is tried to be created")
    public void userWithWrongInputsTriedToBeCreated(String username, String password) {
        newUserIsSelected();
        createUserWith(username, password, password);
    }
    ...
    public void userNotCreated(String errormessage) {
